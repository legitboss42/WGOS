...
Convert a human objective into a structured execution path with routing, dependencies, approvals, and documentation.

## Trigger

Any new mission that needs routing and dependency planning.
...
1. CEO Operator interprets the objective and clarifies the mission.
2. Workflow Orchestrator selects the right workflow and specialist mix.
3. Project Manager creates the task board and dependency order.
4. Specialists execute in sequence.
5. QA validates outcomes.
6. Knowledge Manager updates memory.
7. Documentation Agent finalizes reports and handoff records.
...
- company priorities
- open risks
- available WGOS agents and skills
