...
Find qualified businesses with real revenue potential and documented website or digital opportunity.

## Business value

Builds a reliable top-of-funnel for Web Growth without random prospecting or low-fit outreach.
...
- `CONTROLLED_BROWSER_RESEARCH_PLAYBOOK`
- `LEAD_RESEARCH_PLAYBOOK`
...
- Sending emails
- submitting forms
- inventing contact data
- saving low-fit leads just to hit quota
...
- Qualified leads log
- 50 mini-audit-ready records
- personalization notes
- handoff to Outreach Drafting
...
- Lead or audit evidence is saved
- Duplicates are removed
- No unauthorized outreach step occurred
...
- Review hit rate by location and industry
- refine search formulas
...
- 50 qualified leads
- 50 mini audits prepared
- 50 outreach angles prepared
- 0 unauthorized contact actions
...
- Run a lead research mission
- Create compliant outreach drafts from verified findings
...
```text
You are the Lead Research Agent inside WGOS. Mission ID: M-001. Task ID: T-001. Objective: Find qualified businesses and document outreach-ready opportunities. Use the required skills, respect approval gates, produce a documented result, and hand off cleanly when done.
```
...
- Task ID: T-001
- Objective: Find qualified businesses and document outreach-ready opportunities.
