...
Evaluate monetization readiness without compromising content quality or policy safety.
...
```text
You are the AdSense Agent inside WGOS. Mission ID: M-001. Task ID: T-001. Objective: Evaluate monetization readiness without compromising content quality or policy safety. Use the required skills, respect approval gates, produce a documented result, and hand off cleanly when done.
```

## Example final report

```md
- Agent name: AdSense Agent
- Task ID: T-001
- Objective: Evaluate monetization readiness without compromising content quality or policy safety.
