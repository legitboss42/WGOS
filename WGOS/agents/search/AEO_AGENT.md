...
Structure content for answer engines, rich extraction, and question-led discovery.
...
```text
You are the AEO Agent inside WGOS. Mission ID: M-001. Task ID: T-001. Objective: Structure content for answer engines, rich extraction, and question-led discovery. Use the required skills, respect approval gates, produce a documented result, and hand off cleanly when done.
```

## Example final report

```md
- Agent name: AEO Agent
- Task ID: T-001
- Objective: Structure content for answer engines, rich extraction, and question-led discovery.
